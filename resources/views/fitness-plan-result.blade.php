<x-app-layout>
    <x-slot name="title">
        LifeSync - Your Personalized Fitness Plan
    </x-slot>
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush bg-transparent">
                                            ...
                                            <li class="list-group-item d-flex align-items-center border-0 px-0 py-3 bg-transparent">
                                                ...
                                                <div>
                                                    <small class="text-muted d-block">Nutrition Goal</small>
                                                    <span class="fw-medium">{{ ucfirst(str_replace('_', ' ', $fitnessProfile->nutrition_goal)) }}</span>
                                                </div>
                                            </li>
                                            
                                            @if($fitnessProfile->foods_to_avoid)
                                            <li class="list-group-item d-flex align-items-center border-0 px-0 py-3 bg-transparent">
                                                <span class="badge rounded-pill p-2 me-3" style="background-color: #d38ded;">
                                                    <i class="fas fa-ban text-white"></i>
                                                </span>
                                                <div>
                                                    <small class="text-muted d-block">Foods to Avoid</small>
                                                    <span class="fw-medium">{{ $fitnessProfile->foods_to_avoid }}</span>
                                                </div>
                                            </li>
                                            @endif
                                            ...
                                            <li class="list-group-item d-flex align-items-center border-0 px-0 py-3 bg-transparent">
                                                ...
                                                <div>
                                                    <small class="text-muted d-block">Mental Wellness Goal</small>
                                                    <span class="fw-medium">{{ ucfirst(str_replace('_', ' ', $fitnessProfile->mental_goal)) }}</span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="list-group-item d-flex align-items-center border-0 px-0 py-3 bg-transparent">
                                                ...
                                                <div>
                                                    <small class="text-muted d-block">Sleep Quality</small>
                                                    <span class="fw-medium">{{ ucfirst($fitnessProfile->sleep_quality) }}</span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="list-group-item d-flex align-items-center border-0 px-0 py-3 bg-transparent">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium">{{ ucfirst($fitnessProfile->stress_level) }}</span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="list-group-item d-flex align-items-center border-0 px-0 py-3 bg-transparent">
                                                ...
                                                <div>
                                                    <small class="text-muted d-block">Welness Methods</small>
                                                    <span class="fw-medium">{{ implode(', ', json_decode($fitnessProfile->wellness_methods)) }}</span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-lg-8">
                                <div class="card h-100 border-0 shadow-sm rounded-4">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="fitness-plan-content" style="max-height: 900px; overflow-y: auto; color:#4a26b9;">
    ...
    <style>
        ...
        /* Alternative approach if the above doesn't target all links */
        header a, 
        nav a,
        .dropdown a {
            text-decoration: none !important;
        ...
        /* For specific Tailwind navigation components */
        [x-data] a {
            text-decoration: none !important;
        }
        ...
        .fitness-heading-main {
            ...
            border-bottom: 2px solid rgba(89, 47, 222, 0.2) !important;
        }
        ...
        .fitness-heading {
            ...
            border-bottom: 1px solid rgba(89, 47, 222, 0.1) !important;
        }
        ...
        .week-heading {
            color: #d38ded !important;
            font-size: 1.3rem !important;
        }

        /* Subheadings */
        .fitness-subheading {
            color: #d959e5 !important;
        ...
        .day-heading {
            background-color: rgba(217, 89, 229, 0.05) !important;
            padding: 0.5rem 0.75rem !important;
            border-radius: 0.4rem !important;
            display: inline-block !important;
        }

        .fitness-meal-heading, .fitness-time-heading {
            color: #d38ded !important;
        ...
        .fitness-plan-content li:before {
            content: "•" !important;
            color: #d959e5 !important;
